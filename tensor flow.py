"""
Code was taken primarily from the second source.
1. Intro to pandas
...
# Step 1: Define Features and Configure Feature Columns, and define target/label.
...
# Step 2: Configure LinearRegressor.
...
# Define the input function to instruct tensor flow to pre-process, batch, shuffle, and repeat
...
Change these parameters to achieve an efficient runtime. 
"""

# Correct and most accurate Model.
train_model(
